# SO1 — Lezione 1: Introduzione ai Sistemi Operativi
**Docente:** Prof. Alberto Finzi | **CFU:** 9 | **Aula:** B6
...
$$
> - Ricevimento: Venerdì 15:00–17:00 (Teams, o in presenza su accordo)
$$
...
```mermaid
flowchart LR
    A[MULTICS \n Bell Labs, ~1965] -->|troppo complesso| B[UNIX\nThompson & Ritchie, 1969]
    B --> C[Linguaggio C\nRitchie]
    B --> D[Famiglie Unix\nBSD, System V...]
    D --> E[Minix\nTanenbaum]
    E --> F[Linux\nTorvalds, 1991]
