...
Il **Job** è più astratto: lavoro computazionale (che può generare processi).
...
## Layout di Memoria del Processo
...
- **Stack** contenente i dati temporanei:
  - Parametri di funzione, indirizzi di ritorno, variabili locali.
...
- I processi possono diramarsi in più sottounità di esecuzione.
  ...
  - Archivizações di ulteriori informazione per thread in PCB.
...
- Seleziona quale processo deve essere portato nella coda ready.
...
- I processi possono essere descritti come:
  ...
  - Il long-term scheduler cerca di trovare una buona combinazione di processi.
...
*(Ripetizione per chiarezza visiva)*
...
- Messaggi – processi comunicano senza ricorrere a variabli condivise, ma si scambiano messaggi.
...
□ Propertà del canale:
  □ Canale stabilito solo se i processi condividono una mailbox.
