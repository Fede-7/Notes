...
### 21-03-2025
- [ ] 4.1 EQUIPOTENZA $\Leftrightarrow \exists f \text{ biettiva}$  
...
- [ ] 6.5 $(S, *)$ GRUPPO SE $*$ ASSOCIATIVO, $\exists$ u NEUTRO, OGNI ELEMENTO SIMMETRIZZABILE  
- [ ] 6.6 $(S, *)$ GRUPPO ABELIANO SE VALE ANCHE COMMUTATIVITÀ  

### 01-04-2025
- [ ] 7.1 DEFINIZIONE ANELLO $(A, +, \cdot)$  
  - [ ] $(A, +)$ GRUPPO ABELIANO  
  - [ ] $(A, \cdot)$ SEMIGRUPPO  
  - [ ] DISTRIBUTIVA SU +  
