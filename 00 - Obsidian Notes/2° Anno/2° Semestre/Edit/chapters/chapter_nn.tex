...
\section{Esercizi d'esame di intercorso}
...
\textbf{Soluzione: } \(D=\cbrakets{x \in \mbN \vert x \in W_x \cap \overline{C}}\). In oltre \(C\) ricorsivo \(\iff \overline{C}\) ricorsivamente enumerabile. Allora possiamo riscrivere \(D=K \cap \overline{C}\), che è ricorsivamente enumerabile.