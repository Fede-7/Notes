...
```mermaid
graph TB
    subgraph Mercati["Mercati di Scambio"]
        ML["Mercato del Lavoro"]
        MC["Mercato dei Capitali"]
        MP["Mercato della Produzione"]
        MV["Mercato di Vendita"]
    end
    
    IMPRESA["IMPRESA"]
    
    ML -->|Personale: Informatici,<br/>Tecnici, Commerciali| IMPRESA
    MC -->|Fonti di capitale<br/>e finanziamenti| IMPRESA
    MP -->|Fornitori,<br/>Materie Prime,<br/>Materiali| IMPRESA
    IMPRESA -->|Prodotti e Servizi| MV
    
    style IMPRESA fill:#4a9eff,color:#fff,stroke:#01579b,stroke-width:3px
